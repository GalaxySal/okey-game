...
export const TileComponent: React.FC<TileProps> = ({
  ...
  return (
    <div
      className={`
        w-12 h-16 rounded-lg border-2 cursor-pointer transition-all duration-200 flex flex-col items-center justify-center text-white font-bold text-sm relative
